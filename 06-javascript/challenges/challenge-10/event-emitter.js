...
// Emit events
emitter.emit('userLogin', { name: 'siva', email: 'siva@example.com' });
// siva logged in
// Send welcome email to siva@example.com
...
emitter.emit('userLogin', { name: 'sai', email: 'sai@example.com' });
// Send welcome email to sai@example.com
